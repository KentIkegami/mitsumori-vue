...
<!DOCTYPE html>
  ...
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="stylesheet" href="https://unpkg.com/mitsumori-vue@0.2.0/dist/style.css">
  ...
  <script type="importmap">
    {
      "imports": {
        ...
        "mitsumori-vue": "https://unpkg.com/mitsumori-vue@0.2.0/dist/mitsumori-vue.es.js"
      }
    }
  </script>
  <script type="module">
  ...
  const SETTINGS = {
    url: "https://unpkg.com/mitsumori-vue@0.2.0/dist/example.json"
  }
...
[https://unpkg.com/mitsumori-vue@0.2.0/dist/example.json](https://unpkg.com/mitsumori-vue@0.2.0/dist/example.json)
